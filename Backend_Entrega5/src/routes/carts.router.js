...
// Función para leer el contenido del archivo carts.json
async function leerCartsJSON() {
    try {
...
// Endpoint para obtener la información de todos los carritos
router.get("/", async (req, res) => {
    try {
        const carts = await leerCartsJSON();
        res.json(carts);
    } catch (error) {
